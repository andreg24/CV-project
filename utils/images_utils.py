...
def split_train_val(X, y, split_ratio=0.85, indices=None):
    ...
    It returns the splitted datasets plus the splitting indexes"""
...
def build_loaders(train_dataset, val_dataset, test_dataset):
    """Starting from train, validation and test datasets, returns a tuple containing the three dataloaders"""
